...
RUN mkdir -p /app/app/config && \
    ...
    echo '{"database": {  "host": "db_production",  "port": 3306,  "user": "sophie",  "password": "sophie",  "database": "CUBE"},"secret": "25ad17cf-ebda-4147-9abe-b1b5148664f5"}' >> /app/app/config/db.config.json
